...
http.createServer(function(request, response) {
    ...
    */
    ...
    if(url_parts.pathname == '/submit') { //Processing the form content, if the relative URL is '/ submit'
        ...
        const file = __dirname.concat(input)
	    ...
	    //response.write(resp); //Place given data (here: 'Hello' text) in the body of the answer
	    ...
	    response.write('<label for="name">Give your file or directory</label>');
